    ...
    <div class="row">
        <div class="col-lg-6">
            <div class="card card-default">
                ...
                <div class="card-body">
                    @include('administrator.partials.flash', ['$errors' => $errors])
                    @if (!empty($category))
                        {!! Form::model($category, ['url' => ['administrator/categories', $category->id], 'method' => 'PUT']) !!}
                        {!! Form::hidden('id') !!}
                    @else
                        {!! Form::open(['url' => 'administrator/categories']) !!}
                    @endif
                        ...
                        <div class="form-footer pt-5 border-top">
                            <a href="{{ url('administrator/categories') }}" class="btn btn-secondary btn-default">Back</a>
